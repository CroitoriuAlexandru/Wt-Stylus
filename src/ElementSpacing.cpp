...
ElementSpacingWidget::ElementSpacingWidget()
	: WTemplate(tr("stylus-spacing-template"))
{
	setStyleClass("");
	...
	checkbox_space_x_reverse_ = bindWidget("space.vertical.reverse.controle", std::make_unique<Wt::WCheckBox>("reverse"));
	checkbox_space_y_reverse_ = bindWidget("space.horizontal.reverse.controle", std::make_unique<Wt::WCheckBox>("reverse"));
