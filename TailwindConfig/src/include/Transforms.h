...
namespace Tailwind {
    ...
    public:
        ...
        boost::regex scale_regex = boost::regex("(?<=\n| )(!)?[-]?(scale|scale-x|scale-y)-(150|125|110|105|100|95|90|75|50|0)");
        boost::regex rotate_regex = boost::regex("(?<=\n| )(!)?[-]?rotate-(180|90|45|12|6|3|2|1|0)");
        boost::regex translate_regex = boost::regex("(?<=\n| )(!)?[-]?(translate-x|translate-y)-(full|3\\/4|2\\/4|1\\/4|2\\/3|1\\/3|1\\/2|96|80|72|64|60|56|52|48|44|40|36|32|28|24|20|16|14|12|11|10|9|8|7|6|5|4|3.5|3|2.5|2|1.5|1|0.5|0|px)");
        boost::regex skew_regex = boost::regex("(?<=\n| )(!)?[-]?(skew-y|skew-x)-(12|6|3|2|1|0)");
        boost::regex origin_regex = boost::regex("(?<=\n| )(!)?[-]?origin-(top-left|top-right|bottom-right|bottom-left|top|left|bottom|right|center)");
    };
